...
namespace Opc.Ua
{
    ...
    public class WcfChannelBase<TChannel> : WcfChannelBase where TChannel : class, IChannelBase
    {
            ...
            string configurationName)
        {
            ...
            X509Certificate2 serverCertificate = CertificateFactory.Create(description.ServerCertificate, true);
            EndpointIdentity identity = EndpointIdentity.CreateX509CertificateIdentity(serverCertificate);
            ...
            // add the service certificate into the behavoirs.
